<template>
    <nav class="mobile">
        ...
        <ul class="links md:hidden flex items-center gap-12 text-2xl">
            <a href="/"><Icon name="iconoir:home-alt-slim" /></a>
            <a href="/about"><Icon name="iconoir:home-user" /></a>
            <a href="#contact"><Icon name="iconoir:message" /></a>
        </ul>
    </nav>
</template>
