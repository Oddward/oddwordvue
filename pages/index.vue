<template>
    <div>
        ...
        <section id="hero" class="flex flex-wrap md:flex-nowrap content-center justify-around gap-24 py-8">
        ...
        <section id="main-links" class="flex justify-evenly flex-wrap gap-2 py-8 px-8 mx-auto lg:max-xxl:w-3/4 xxl:px-0">
            <PeekingSocialLinks />
        </section>

        <section id="posts" class="relative py-8 px-8 xxl:my-8">
            <SectionHeader title="BLOG POSTS" class="xxl:hidden my-4"/>
            <BlogPosts preview />
        </section>

        <section id="projects" class="relative py-8 px-8 xxl:my-8">
            <SectionHeader title="PROJECTS" class="xxl:hidden my-4"/>
            <Projects />
        </section>
