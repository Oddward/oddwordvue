...
updatedAt: 2023-03-08T16:00:00+0200
...
Ultimately, a blog doesn't really need to be for anyone else, you can use it like a journal and share it or just let it sit there and refer to it when you need to. The practice of recreational writing is a mainstay in therapy and psychological research as it's been found to improve our mood, immune systems, and a healthier thought process, especially when focusing on its meaning rather than a simple record of events [:Icon{name="icon-park-outline:efferent-four"}](https://www.apa.org/monitor/jun02/writing). 
...
Writing is a form of creative expression and it's a timeless skill to learn and master. Whether you're writing tutorials, letters, or stories about your life, copywriting or introducing something new to people, the more you do it the better you get at it, and combined with other platforms you can learn to communicate the same ideas in different formats and with different constraints until the constraints don't really matter anymore. If you're not used to long form writing, the large space you get with a blog post itself can be a constraint.
...
There has been a little bit of a pushback against massive centralized social media sites being where all the action happens, although discoverability without using social media has become difficult. People have more and more stakes and reliance on those platforms, but when those platforms suddenly make policy and feature changes that hurt existing users it's become clear how unhealthy it is for the internet to be so dependant on them. 

Additionally, search engines like Google were designed for a fragmented internet where your daily objective is to discover new domains and pages that are relevant to you, but due to those shifts mentioned search engines have become less useful and social media sites don't priotize searchability, they want you to engage with a recommendation algorithm designed to take up as much of your time and attention as possible, not to be productive. We got used to things like clickbait and an obsession with negativity and sensationalism to try and get attention in such an environment.

The growth of SEO optimization as a tool to get seen also lead to a lot of low quality sites investing heavily in gaming the system to get their content ranking high on Google, poisoning the quality of search results with regurgitated content, pay-to-win reviews, and stolen or bot-generated content (and not the impressive AI kind). With a come back in decentralization and the low barrier to entry for good-looking personal websites and mini platforms, we'll probably have a resurgance of webportals or other ways of suggesting sites. Some moderns browsers already have improved ways of organizing and sharing webpages such as built-in *pin boards* or *collections*. It's interesting to see where it goes.


::small
Updated March 8th, 2023: rewrites & added graphics
::